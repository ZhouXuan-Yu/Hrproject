...
from app.models.iam import IamDept, IamPosition, IamUser, RecruitApprovalIdentity
...
from app.models.hire import HireEvent, Offer, Entry, OfferRemindLog
from app.models.internal import Employee, EmployeeTagRel, InternalMatchLog
from app.models.auxiliary import RecruitMailAccount, ChatLog, NotifyTemplate, AuditLog, ApiKeyConfig, AiKnowledgeBase, RoleMenuPermission, PasswordResetToken
